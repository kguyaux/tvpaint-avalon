/*
Avalon-Workfilesplugin for TVPaint
...
#define TXT_NAME "tvp_avalon_workfiles"
...
{  
    ...
    */
    ...
    //"GET http://localhost:4242/api/open_workfiles";
    char* request = "OPEN workfiles";

    // send request to avalon-host, which should open the workfiles UI, in thsi case:
